                        ...
                        <div class="confirmation-row">
                            <div class="col-12 text-center">
                                ...
                                <p class="confirmation-detail">
                                    Esta invitación <strong>no tiene costo</strong>, ya que está destinada a nuestros <strong>invitados especiales</strong>.
                                </p>
                                <p class="confirmation-detail">
                                    Será un verdadero honor contar con tu presencia en este evento tan importante.
                                </p>
                            </div>
                        </div>
                    </div>
...
document.getElementById("rsvp-form").addEventListener("submit", function (event) {
    ...
    document.getElementById("cantidadAsistentes").textContent = `Cantidad de asistentes: ${numAsistentes}`;
});
</script>
